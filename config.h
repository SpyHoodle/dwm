...
/* tagging */
static const char *tags[] = { "irc", "www", "dev", "doc", "mus", "trm", "sys", "gme", "msc" };
...
static const char *lockcmd[]  = { "bosskey", "-lu", NULL };

/* for volume keybinds */
#include <X11/XF86keysym.h>

/* for moving windows up and down the stack */
#include "movestack.c"
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_p,                     spawn,          SHCMD("passdmenu") },
  { MODKEY|ShiftMask,             XK_p,                     spawn,          SHCMD("passdmenu --type") },
  { MODKEY,                       XK_a,                     spawn,          SHCMD("st python ~/Development/pyagenda/main.py") },
